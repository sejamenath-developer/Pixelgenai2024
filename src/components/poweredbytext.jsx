...
const PoweredByText = () => {
    return (
        ...
        >
            <p>powered by <a href="" target="_blank" rel="noopener noreferrer"><span className="text-stable-purple font-normal hover:text-darkorange transition-colors duration-500 ">sdevelopment.ai</span></a></p>
        </motion.div>
    );
}
